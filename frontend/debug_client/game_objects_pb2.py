...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x12game_objects.proto\x12\x1a\x65ndpoints.flunky.simulator\"\xe2\x01\n\tGameState\x12\x11\n\tabgegeben\x18\x06 \x03(\t\x12>\n\nroundPhase\x18\x07 \x01(\x0e\x32*.endpoints.flunky.simulator.EnumRoundPhase\x12:\n\nruleConfig\x18\x08 \x01(\x0b\x32&.endpoints.flunky.simulator.RuleConfig\x12\x16\n\x0ethrowingPlayer\x18\n \x01(\t\x12\x16\n\x0estrafbierTeamA\x18\x0b \x01(\x03\x12\x16\n\x0estrafbierTeamB\x18\x0c \x01(\x03\")\n\nRuleConfig\x12\x1b\n\x13restingPeriodLength\x18\x01 \x01(\x03*\xb2\x01\n\x0e\x45numRoundPhase\x12\x11\n\rUNKNOWN_PHASE\x10\x00\x12\x18\n\x14NO_ACTIVE_GAME_PHASE\x10\x01\x12\x19\n\x15TEAM_A_THROWING_PHASE\x10\x02\x12\x19\n\x15TEAM_B_THROWING_PHASE\x10\x03\x12\x11\n\rRESTING_PHASE\x10\x04\x12\x14\n\x10TEAM_A_WON_PHASE\x10\x05\x12\x14\n\x10TEAM_B_WON_PHASE\x10\x06*|\n\x11\x45numThrowStrength\x12\x1a\n\x16UNKNOWN_THROW_STRENGTH\x10\x00\x12\x17\n\x13SOFT_THROW_STRENGTH\x10\x01\x12\x19\n\x15MEDIUM_THROW_STRENGTH\x10\x02\x12\x17\n\x13HARD_THROW_STRENGTH\x10\x03*W\n\tEnumTeams\x12\x11\n\rUNKNOWN_TEAMS\x10\x00\x12\x13\n\x0fSPECTATOR_TEAMS\x10\x01\x12\x10\n\x0cTEAM_A_TEAMS\x10\x02\x12\x10\n\x0cTEAM_B_TEAMS\x10\x03\x42;\n*de.flunkyteam.endpoints.projects.simulatorB\x0bGameObjectsP\x01\x62\x06proto3'
)

_ENUMROUNDPHASE = _descriptor.EnumDescriptor(
  name='EnumRoundPhase',
  full_name='endpoints.flunky.simulator.EnumRoundPhase',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NO_ACTIVE_GAME_PHASE', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TEAM_A_THROWING_PHASE', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TEAM_B_THROWING_PHASE', index=3, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RESTING_PHASE', index=4, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TEAM_A_WON_PHASE', index=5, number=5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TEAM_B_WON_PHASE', index=6, number=6,
      serialized_options=None,
      type=None),
  ],
...
_sym_db.RegisterEnumDescriptor(_ENUMROUNDPHASE)

EnumRoundPhase = enum_type_wrapper.EnumTypeWrapper(_ENUMROUNDPHASE)
...
_GAMESTATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='abgegeben', full_name='endpoints.flunky.simulator.GameState.abgegeben', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='roundPhase', full_name='endpoints.flunky.simulator.GameState.roundPhase', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ruleConfig', full_name='endpoints.flunky.simulator.GameState.ruleConfig', index=2,
...
_GAMESTATE.fields_by_name['roundPhase'].enum_type = _ENUMROUNDPHASE
...
DESCRIPTOR.enum_types_by_name['EnumRoundPhase'] = _ENUMROUNDPHASE
