...
class SimulatorStub(object):
  ...
  def __init__(self, channel):
    ...
    self.StreamVideoEvents = channel.unary_stream(
        ...
        request_serializer=flunkyprotocol__pb2.StreamVideoEventsReq.SerializeToString,
        response_deserializer=flunkyprotocol__pb2.StreamVideoEventsResp.FromString,
        )
...
def add_SimulatorServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'StreamVideoEvents': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=flunkyprotocol__pb2.StreamVideoEventsReq.FromString,
          response_serializer=flunkyprotocol__pb2.StreamVideoEventsResp.SerializeToString,
      ),
