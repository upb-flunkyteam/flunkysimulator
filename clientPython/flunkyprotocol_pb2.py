...
_ENUMLOGINSTATUS = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOGIN_STATUS_NOT_STRIPED', index=5, number=5,
      serialized_options=None,
      type=None),
  ],
