...
proto.endpoints.flunky.simulator.StreamVideoEventsResp.toObject = function(includeInstance, msg) {
  var f, obj = {
    event: (f = msg.getEvent()) && proto.endpoints.flunky.simulator.VideoEvent.toObject(includeInstance, f)
  };
...
proto.endpoints.flunky.simulator.StreamVideoEventsResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.endpoints.flunky.simulator.VideoEvent;
      reader.readMessage(value,proto.endpoints.flunky.simulator.VideoEvent.deserializeBinaryFromReader);
      msg.setEvent(value);
      break;
    default:
      reader.skipField();
...
proto.endpoints.flunky.simulator.StreamVideoEventsResp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.endpoints.flunky.simulator.VideoEvent.serializeBinaryToWriter
    );
  }
};
...
proto.endpoints.flunky.simulator.StreamVideoEventsResp.prototype.getEvent = function() {
  return /** @type{?proto.endpoints.flunky.simulator.VideoEvent} */ (
    jspb.Message.getWrapperField(this, proto.endpoints.flunky.simulator.VideoEvent, 1));
};
 ...
 * @return {string}
 */
proto.endpoints.flunky.simulator.AbgegebenReq.prototype.getTargename = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.endpoints.flunky.simulator.AbgegebenReq} returns this
 */
proto.endpoints.flunky.simulator.AbgegebenReq.prototype.setTargename = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
