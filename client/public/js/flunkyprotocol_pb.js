...
goog.exportSymbol('proto.endpoints.flunky.simulator.EnumAbgegebenRespStatus', null, global);
goog.exportSymbol('proto.endpoints.flunky.simulator.EnumLoginStatus', null, global);
goog.exportSymbol('proto.endpoints.flunky.simulator.EnumThrowRespStatus', null, global);
...
goog.exportSymbol('proto.endpoints.flunky.simulator.RestingPeriodReq', null, global);
 ...
 * @constructor
 */
proto.endpoints.flunky.simulator.RestingPeriodReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.endpoints.flunky.simulator.RestingPeriodReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.endpoints.flunky.simulator.RestingPeriodReq.displayName = 'proto.endpoints.flunky.simulator.RestingPeriodReq';
}
...
proto.endpoints.flunky.simulator.AbgegebenResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.endpoints.flunky.simulator.EnumAbgegebenRespStatus} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
...
/**
 * optional EnumAbgegebenRespStatus status = 1;
 * @return {!proto.endpoints.flunky.simulator.EnumAbgegebenRespStatus}
 */
proto.endpoints.flunky.simulator.AbgegebenResp.prototype.getStatus = function() {
  return /** @type {!proto.endpoints.flunky.simulator.EnumAbgegebenRespStatus} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.endpoints.flunky.simulator.EnumAbgegebenRespStatus} value
 * @return {!proto.endpoints.flunky.simulator.AbgegebenResp} returns this
 */
proto.endpoints.flunky.simulator.AbgegebenResp.prototype.setStatus = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
...
proto.endpoints.flunky.simulator.ThrowResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.endpoints.flunky.simulator.EnumThrowRespStatus} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
...
/**
 * optional EnumThrowRespStatus status = 1;
 * @return {!proto.endpoints.flunky.simulator.EnumThrowRespStatus}
 */
proto.endpoints.flunky.simulator.ThrowResp.prototype.getStatus = function() {
  return /** @type {!proto.endpoints.flunky.simulator.EnumThrowRespStatus} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.endpoints.flunky.simulator.EnumThrowRespStatus} value
 * @return {!proto.endpoints.flunky.simulator.ThrowResp} returns this
 */
proto.endpoints.flunky.simulator.ThrowResp.prototype.setStatus = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.prototype.toObject = function(opt_includeInstance) {
  return proto.endpoints.flunky.simulator.RestingPeriodReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.endpoints.flunky.simulator.RestingPeriodReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.endpoints.flunky.simulator.RestingPeriodReq}
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.endpoints.flunky.simulator.RestingPeriodReq;
  return proto.endpoints.flunky.simulator.RestingPeriodReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.endpoints.flunky.simulator.RestingPeriodReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.endpoints.flunky.simulator.RestingPeriodReq}
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.endpoints.flunky.simulator.RestingPeriodReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.endpoints.flunky.simulator.RestingPeriodReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.prototype.getMilliseconds = function() {
...
/**
 * @param {number} value
 * @return {!proto.endpoints.flunky.simulator.RestingPeriodReq} returns this
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.prototype.setMilliseconds = function(value) {
 ...
 * @return {boolean}
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.prototype.getActive = function() {
 ...
 * @return {!proto.endpoints.flunky.simulator.RestingPeriodReq} returns this
 */
proto.endpoints.flunky.simulator.RestingPeriodReq.prototype.setActive = function(value) {
 ...
 * @enum {number}
 */
proto.endpoints.flunky.simulator.EnumAbgegebenRespStatus = {
 ...
 * @enum {number}
 */
proto.endpoints.flunky.simulator.EnumThrowRespStatus = {
